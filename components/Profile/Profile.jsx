  ...
  return (
    ...
    >
      <defs>
        ...
        ></path>
        <path
          d="M 124 144.611 L 124 163 L 128 163 L 128 163 C 167.7645 163 200 195.2355 200 235 L 190 235 L 5 235 L 0 235 C -0 195.2355 32.2355 163 72 163 L 72 163 L 76 163 L 76 144.611 C 58.7626 136.4224 46.3722 119.687 44.3051 99.8812 C 38.4803 99.0578 34 94.0521 34 88 L 34 74 C 34 68.054 38.3246 63.1181 44 62.1659 L 44 56 L 44 56 C 44 25.0721 69.0721 0 100 0 L 100 0 L 100 0 C 130.9279 -0 156 25.0721 156 56 L 156 62.1659 C 161.6754 63.1181 166 68.054 166 74 L 166 88 C 166 94.0521 161.5197 99.0578 155.6949 99.8812 C 153.6278 119.687 141.2374 136.4224 124 144.611 Z"
          id="react-path-3"
        ></path>
      </defs>
        ...
        <g transform="translate(-825.000000, -1100.000000)" id="Avataaar/Circle">
          <g transform="translate(825.000000, 1100.000000)">
            ...
            <g id="Avataaar" strokeWidth="1" fillRule="evenodd" mask="url(#react-mask-5)">
              ...
              <motion.g
                animate={hovered ? { x: 0, y: [170, 161, 170] } : { x: 0, y: 170 }}
                initial={{ x: 0, y: 170 }}
                transition={hovered ? { repeat: Infinity, duration: 0.5 } : {}}
                id="Clothing/Hoodie"
              ...
              >
                <defs>
                  <path
                    d="M 108 20 C 90.0813 15.0759 76.2798 20.5518 76.0042 34.645 C 50.1464 45.5681 32 71.1646 32 100.9995 L 32 100.9995 L 32 110 L 232 110 L 232 100.9995 C 232 71.1646 213.8536 45.5681 187.9958 34.645 C 187.7202 20.5518 173.9187 15.0759 156 20 L 156 32 L 156 32 C 156 45.2548 145.2548 56 132 56 L 132 56 C 118.7452 56 108 45.2548 108 32 L 108 15 Z"
                    id="react-path-7"
                  ></path>
                </defs>
                ...
                <use id="Hoodie" fill="#F396A4" fillRule="evenodd" xlinkHref="#react-path-7"></use>
                <g id="Color/Palette/Gray-01" mask="url(#react-mask-8)" fillRule="evenodd" fill="var(--color-primary)">
